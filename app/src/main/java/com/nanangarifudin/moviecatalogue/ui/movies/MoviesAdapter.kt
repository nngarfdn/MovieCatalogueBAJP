...
class MoviesAdapter :
    ...
    private lateinit var cardList: List<MovieItem>

    fun setData(cardList: List<MovieItem>){
...
//        Glide.with(holder.itemView.context).load(Constant.POSTER_URL + currentItem.poster_path).into(holder.photo)
