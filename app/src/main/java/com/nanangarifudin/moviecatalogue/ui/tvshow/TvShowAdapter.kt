...
//
//    private lateinit var cardList: List<TVResponse>
//
//    fun setData(cardList: List<TVResponse>) {
...
//
//        val url = "https://image.tmdb.org/t/p/w600_and_h900_bestv2${currentItem.poster_path}"
//        Picasso.get()
//            .load(url)
//            .fit()
//            .centerCrop()
